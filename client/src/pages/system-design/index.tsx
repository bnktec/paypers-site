        ...
        <section className="space-y-6">
          ...
          <div className="space-y-8 bg-white p-8 rounded-xl border border-neutral-light">
            <div className="border-b border-neutral-lighter pb-6">
              <p className="text-[12px] text-neutral-regular mb-4 font-mono">Screen Title (h1) • Montserrat SemiBold 48px • Line Height 130% • L.S -1.6%</p>
              <h1 className="text-[48px] font-semibold leading-[1.3] tracking-[-1.6%]">Simplificando a Negociação de Precatórios</h1>
            </div>
            
            <div className="border-b border-neutral-lighter pb-6">
              <p className="text-[12px] text-neutral-regular mb-4 font-mono">Section Title (h3) • Montserrat SemiBold 24px • Line Height 130% • L.S -0.8%</p>
              <h2 className="text-[24px] font-semibold leading-[1.3] tracking-[-0.8%]">Simplificando a Negociação de Precatórios</h2>
            </div>
            
            <div className="border-b border-neutral-lighter pb-6">
              <p className="text-[12px] text-neutral-regular mb-4 font-mono">Section Inner Title (h5) • Montserrat SemiBold 18px • Line Height 150% • L.S 0%</p>
              <h3 className="text-[18px] font-semibold leading-[1.5]">Simplificando a Negociação de Precatórios</h3>
            </div>
            
            <div className="border-b border-neutral-lighter pb-6">
              <p className="text-[12px] text-neutral-regular mb-4 font-mono">Body (p) • Montserrat Regular 16px • Line Height 150% • L.S 0%</p>
              <p className="text-[16px] leading-[1.5]">Simplificando a Negociação de Precatórios</p>
            </div>

            <div className="border-b border-neutral-lighter pb-6">
              <p className="text-[12px] text-neutral-regular mb-4 font-mono">Small - Regular (small) • Montserrat Regular 14px • Line Height 130% • L.S 0%</p>
              <p className="text-[14px] leading-[1.3]">Simplificando a Negociação de Precatórios</p>
            </div>

            <div className="border-b border-neutral-lighter pb-6">
              <p className="text-[12px] text-neutral-regular mb-4 font-mono">Small - Medium (small) • Montserrat Medium 14px • Line Height 130% • L.S 0%</p>
              <p className="text-[14px] font-medium leading-[1.3]">Simplificando a Negociação de Precatórios</p>
            </div>

            <div>
              <p className="text-[12px] text-neutral-regular mb-4 font-mono">Extra Small - Regular (span) • Montserrat Regular 12px • Line Height 100% • L.S 0%</p>
